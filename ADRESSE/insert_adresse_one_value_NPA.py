# insert_adresse_one_value_NPA.py
...
try:
    ...
    valeur_debile_mais_presque_aleatoire_a_inserer = 1001
    ...
    mysql_insert_string = "INSERT IGNORE INTO t_adresse (id_adresse, NpaAdresse) VALUES (null, %(values_insert)s)"
