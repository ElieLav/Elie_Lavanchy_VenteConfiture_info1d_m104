...
try:
    ...
    valeur_update_dictionnaire = {'value_RueAdresse': valeur_adresse, 'no_ligne_update': numero_ligne_table_update}

    # Pour la mise à jour on doit avoir au moins deux valeurs "numero_ligne_table_update" et "valeur_genre"
    mysql_update_string = "UPDATE t_adresse SET RueAdresse = %(value_RueAdresse)s WHERE id_adresse = %(no_ligne_update)s"
