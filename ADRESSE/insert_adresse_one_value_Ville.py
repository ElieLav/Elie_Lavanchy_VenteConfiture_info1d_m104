# insert_adresse_one_value_Ville.py
...
try:
    ...
    valeur_debile_mais_presque_aleatoire_a_inserer = "St-Légier"
    ...
    mysql_insert_string = "INSERT IGNORE INTO t_adresse (id_adresse, VilleAdresse) VALUES (null, %(values_insert)s)"
