...
try:
    ...
    numero_ligne_table_update = 1

    # Définir une valeur pour la mise à jour du champ "intitule_genre"
    valeur_adresse = "testupdate3"
    # Afficher la valeur dans la console...c'est tout, vraiment tout !
    print("valeur_adresse ",valeur_adresse, "; numero_ligne_table_update ",numero_ligne_table_update)
    ...
    valeur_update_dictionnaire = {'value_VilleAdresse': valeur_adresse, 'no_ligne_update': numero_ligne_table_update}

    # Pour la mise à jour on doit avoir au moins deux valeurs "numero_ligne_table_update" et "valeur_genre"
    mysql_update_string = "UPDATE t_adresse SET VilleAdresse = %(value_VilleAdresse)s WHERE id_adresse = %(no_ligne_update)s"
