...
try:
    ...
    numero_ligne_table_update = 3

    # Définir une valeur pour la mise à jour du champ "intitule_genre"
    valeur_client = "testupdate2"
    # Afficher la valeur dans la console...c'est tout, vraiment tout !
    print("valeur_client ",valeur_client, "; numero_ligne_table_update ",numero_ligne_table_update)
    ...
    valeur_update_dictionnaire = {'value_PrenomClient': valeur_client, 'no_ligne_update': numero_ligne_table_update}

    # Pour la mise à jour on doit avoir au moins deux valeurs "numero_ligne_table_update" et "valeur_genre"
    mysql_update_string = "UPDATE t_client SET PrenomClient = %(value_PrenomClient)s WHERE id_client = %(no_ligne_update)s"
