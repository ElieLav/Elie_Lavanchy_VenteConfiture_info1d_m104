# insert_client_one_value_prenom.py
...
try:
    ...
    valeur_debile_mais_presque_aleatoire_a_inserer = "Elie"
    ...
    mysql_insert_string = "INSERT IGNORE INTO t_client (id_client, PrenomClient) VALUES (null, %(values_insert)s)"
