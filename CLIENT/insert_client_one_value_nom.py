# insert_client_one_value_nom.py
...
try:
    ...
    valeur_debile_mais_presque_aleatoire_a_inserer = "Lavanchy"
    ...
    mysql_insert_string = "INSERT IGNORE INTO t_client (id_client, NomClient) VALUES (null, %(values_insert)s)"
