...
try:
    ...
    valeur_client = "testupdate1"
    # Afficher la valeur dans la console...c'est tout, vraiment tout !
    print("valeur_nom ",valeur_client, "; numero_ligne_table_update ",numero_ligne_table_update)
    ...
    valeur_update_dictionnaire = {'value_NomClient': valeur_client, 'no_ligne_update': numero_ligne_table_update}

    # Pour la mise à jour on doit avoir au moins deux valeurs "numero_ligne_table_update" et "valeur_genre"
    mysql_update_string = "UPDATE t_client SET NomClient = %(value_NomClient)s WHERE id_client = %(no_ligne_update)s"
