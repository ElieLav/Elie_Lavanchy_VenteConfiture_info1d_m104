# insert_clients_multi_values.py
...
try:
    ...
    valeur_ins_1 = "Test"
    valeur_ins_2 = "Test2"
    # suppression de la valeur ins 3 car seulement 2 valeur dans cette table ELavanchy
    # Afficher les valeurs dans la console...c'est tout, vraiment tout !
    print("valeur_ins_1 ",valeur_ins_1, "valeur_ins_2 ",valeur_ins_2)

    # Définitions d'un dictionnaire pour passer les valeurs en paramètres de façon un "peu" sécurisée dans la BD
    valeurs_insertion_dictionnaire = {'value_nomdefamille_client': valeur_ins_1, 'value_prenom_client': valeur_ins_2}
    ...
    mysql_insert_string = "INSERT INTO t_client (id_client, NomClient, PrenomClient)VALUES (NULL, %(value_nomdefamille_client)s, %(value_prenom_client)s)"
